(function () {
    function injectHeader() {
        ...
        const headerStyles = `
            ...
            /* Modern Inset Card Style */
            .header-control-card {
                display: flex;
                align-items: center; 
                gap: 24px; /* Increased Spacing */
                background: rgba(0, 0, 0, 0.03); /* Light mode inset bg */
                padding: 6px 20px;
                border-radius: 9999px; /* Smooth pill */
                box-shadow: inset 0 2px 4px 0 rgba(0, 0, 0, 0.05); /* Sunken look */
                transition: background 0.5s cubic-bezier(0.4, 0, 0.2, 1), box-shadow 0.5s cubic-bezier(0.4, 0, 0.2, 1);
            }
            
            .dark .header-control-card {
                background: rgba(255, 255, 255, 0.03); /* Dark mode inset bg */
                box-shadow: inset 0 2px 4px 0 rgba(0, 0, 0, 0.2);
            }

            .magnetic-btn {
                border: none !important; /* Ensure buttons have no default border */
            }
        `;
